...
function Registration() {
  ...
  const allRegisterUserData = useSelector((state) => state.getRegistrationDataReducer);
          ...
          <div className="Registration-form-wrapper">
            <form id="contact-form" method="post" className="Registration-form-group">
              ...
              >
                <option>Select from dropdown</option>
                {
                  allRegisterUserData && allRegisterUserData.data && allRegisterUserData.data.map((register, id) => {
